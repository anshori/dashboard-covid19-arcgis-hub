    ...
    var kasuspositif = L.geoJson(null, {
      pointToLayer: function (feature, latlng) {
        var geojsonMarkerOptions = {
          radius: feature.properties.Kasus_Posi/10,
          fillColor: "red",
          color: "gray",
          weight: 0.7,
          opacity: 1,
        ...
        if (feature.properties) {
          ...
          layer.on({
            ...
            mouseover: function (e) {
              kasuspositif.bindTooltip("Prov. " + feature.properties.Provinsi + "<br>Kasus Positif: " + feature.properties.Kasus_Posi, {sticky: true});
            }
          });
        }
      }
